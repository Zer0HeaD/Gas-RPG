 ...
 */
UCLASS()
class GAS_RPG_PROJECT_API URPG_ParkourMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Prone") float ProneMaxSpeed = 100.f;                //ProneMaxSpeed
	...
	UPROPERTY(EditDefaultsOnly, Category = "Wallrun") float MaxWallrunSpeed = 750.f;
	...
	UPROPERTY(EditDefaultsOnly, Category = "Wallrun") float WallJumpOffForce = 500.f;
	...
	//Transient
	UPROPERTY(Transient) ARPG_Player_Character* ExtendedCharacterOwner;
