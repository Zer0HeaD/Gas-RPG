 ...
 */
UCLASS()
class GAS_RPG_PROJECT_API UProneAnimInstance : public UAnimInstance
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Aim, Meta = (AllowPrivateAccess = true))
	ARPG_Player_Character* Player = nullptr;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Aim, Meta = (AllowPrivateAccess = true))
	URPG_ParkourMovementComponent* MovementComponentRef = nullptr;
